    ...
    <div className="bg-black text-white min-h-screen">
          ...
          >
            ...
            {sponsors.platinum.map((s, i) => (
              <motion.div
                ...
                className="border border-white/20 p-6 md:p-12 grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-6 md:gap-10 items-start hover:border-white/40 transition-colors duration-300"
              >
                <div className="w-28 h-28 bg-white/5 border border-white/10 rounded-lg flex items-center justify-center">
                  <span className="text-3xl font-bold text-white/60">{s.initials}</span>
                </div>
                <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {sponsors.gold.map((s, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="border border-yellow-500/20 p-8 hover:border-yellow-500/40 transition-colors duration-300"
                >
                  <div className="w-16 h-16 bg-yellow-500/10 rounded-lg flex items-center justify-center mb-6">
                    <span className="text-xl font-bold text-yellow-500/60">{s.initials}</span>
                  </div>
                  ...
                  <p className="text-gray-500 text-xs tracking-wider mb-4">{s.type}</p>
                  <p className="text-gray-400 leading-relaxed">{s.contribution}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {sponsors.silver.map((s, i) => (
                ...
                >
                  <div className="w-12 h-12 bg-gray-800 rounded flex items-center justify-center mb-5">
                    <span className="text-sm font-bold text-gray-500">{s.initials}</span>
                  </div>
      ...
      <section className="py-20 md:py-32 px-6 md:px-8 text-center">
        ...
        >
          ...
          <a
            href="mailto:sponsors@megabyte.pk"
